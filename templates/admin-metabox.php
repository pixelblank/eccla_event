...
<p>
    ...
    <div style="display: flex; gap: 10px; margin-top: 10px;">
        ...
        <div style="flex: 1;">
            <small>Couleur de l'événement</small><br>
            <input type="text" name="event_color" class="eccla-color-picker" value="<?php echo esc_attr(get_post_meta($post->ID, '_event_color', true) ?: '#53a92c'); ?>">
        </div>
    </div>
</p>
<p>
